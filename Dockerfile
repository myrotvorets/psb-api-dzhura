FROM myrotvorets/node:latest@sha256:a4a0591f3debc0a495157e42bd379cdc1b1dfa21ba9a3a79035733c939c7930d AS base
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:eea0e716b19e461de36ed8ebb05da8bffaeae95fa283c35ef4f98e9de3574a7d
USER root
WORKDIR /srv/service
RUN chown nobody:nobody /srv/service
