FROM myrotvorets/node:latest@sha256:085de72d6cc284305645d5d0021112f7133302ed0029a90da8a5e7392feba242 AS base
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:e15fdf6cf67bbe60babe69e8c3703a7abc18f819ae3c53cb84aea47d2dd29884
USER root
WORKDIR /srv/service
RUN chown nobody:nobody /srv/service
